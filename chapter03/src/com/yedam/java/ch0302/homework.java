...
public class homework {
	...
	public static void main(String[] args) {
		// 문제1) 아래와 같이 각 변수를 초기화하였을 때 각 문제에 맞게 구현하세요.
				...
				// 1-2) 변수 x의 값을 증가시킨 후 변수 y의 값과 더한 다음 변수 y의 값을 감소시키는 연산식을 한줄로 작성하세요. x↑ + y = y↓
				result = ++x + y--;
				...
				System.out.println( ( m*2 == n*3 ) || ( n<5 ) );
				...
				val -= 5;
				System.out.println("val = val - 5 "+ val);
				val *= 3;
				System.out.println("val = val * 3 "+ val);
				val /= 5;
				System.out.println("val = val / 5 "+ val);
				
				// 문제4) 위에서 사용한 변수 val의 값이 양수일 경우엔 변수 값을, 아닐 경우엔 0을 담는 변수를 선언하세요. (단, 삼항연산자를 사용)
				int val1 = (val > 0) ? val  : 0;
				System.out.printf("변수값은 %d \n",val1);
				...
				String message = (a < 0 || b < 0 ) ? "One of a or b is negative number" : "both a and b are zero or more" ;
